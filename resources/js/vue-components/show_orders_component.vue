    ...
    <div  class="card col-lg-12 col-11 p-0 mb-4">
        <div class="card-header bg-dark text-light">
                 ...
                 <div class="card-body bg-creame">
                     <display-order-items-component v-for="item in order.order_contents" :key="item.id" :product="item"></display-order-items-component>
                     ...
                     <button class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown" v-if="$route.path=='/vendor-orders'">Change Status</button>
